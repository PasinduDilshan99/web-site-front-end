...
export interface PopularTourImage {
  imageName: string;
  imageUrl: string;
}

export interface PopularTourDestination {
...
export interface PopularTourSchedule {
  scheduleId: number;
  scheduleName: string;
  assumeStartDate: string;
  assumeEndDate: string;
  ...
  destinations: PopularTourDestination[];
  reviews: PopularTourReview[];
}
...
export interface PopularTourType {
  ...
  season: string;
  tourStatus: string;
  images: PopularTourImage[];
  schedules: PopularTourSchedule[];
}

export interface PopularTourApiResponse {
  code: number;
  status: string;
  message: string;
...
// Tour Types for Sri Lankan Tours Page
export interface ActiveToursType {
  tourId: number;
  tourName: string;
  tourDescription: string;
...
export interface TourReviewsResponse {
  code: number;
  status: string;
  message: string;
  data: TourReview[];
...
export interface DayDetailsApiResponse {
  code: number;
  status: string;
  message: string;
  data: DayDetails[];
