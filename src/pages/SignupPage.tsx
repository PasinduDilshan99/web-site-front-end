...
export default function SignupPage() {
  ...
  const inputClass = "sea-input w-full pl-12 pr-4 py-3 text-gray-900 bg-white border-2 rounded-xl outline-none transition-all";
      ...
      <div className="min-h-[90vh] flex">
        ...
        >
          <div
            ...
            style={{
            //   backgroundImage: "url('https://res.cloudinary.com/dtzrivqye/image/upload/v1772826422/ik35f0aabsrxurhznpqp.jpg')",
          ...
          <div className="w-full max-w-2xl py-8 relative z-10">
            ...
            {error && (
              <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start space-x-3">
                ...
                <p className="text-sm text-red-700">username or email already taken</p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  { id: "middleName", label: "Middle Name", placeholder: "Middle", required: false, optional: true },
                  { id: "lastName", label: "Last Name", placeholder: "Doe", required: true },
                ].map(({ id, label, placeholder, required, optional }) => (
                  <div key={id}>
                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"><IconUser /></div>
                      <input
                        id={id}
                        name={id}
                        type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"><IconPhone /></div>
                    <input
                      id="mobileNumber1"
                      name="mobileNumber1"
                      type="tel"
              ...
              {/* Terms */}
              <div className="flex items-start space-x-3 p-3 rounded-xl border" style={{ borderColor: "var(--sea-blue-border)", background: "var(--sea-blue-pale)" }}>
                <input
                  type="checkbox"
                  id="terms"
                  required
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link
                  ...
                  onMouseLeave={(e) => (e.currentTarget.style.color = "var(--sea-green)")}
                >
                  Sign in instead
                </Link>
              </p>
