...
const PackageInfo: React.FC<PackageInfoProps> = ({ packageData }) => {
  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-sky-100">
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-sky-600 to-teal-600 bg-clip-text text-transparent mb-4 sm:mb-6">Package Details</h2>

      {/* Package Type */}
      <div className="mb-4 sm:mb-6">
        <h3 className="text-lg sm:text-xl font-semibold text-sky-800 mb-2 sm:mb-3">Package Type</h3>
      ...
      {packageData.packageFeatures && packageData.packageFeatures.length > 0 && (
        <div className="mb-4 sm:mb-6">
          <h3 className="text-lg sm:text-xl font-semibold text-sky-800 mb-2 sm:mb-3">Included Features</h3>
            ...
            {packageData.packageFeatures.map((feature) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {feature.specialNote && (
                    <p className="text-xs sm:text-sm text-sky-600 font-medium">💡 {feature.specialNote}</p>
                  )}
                </div>
              </div>
            ))}
