...
const ActivityCategoriesHome = () => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-4 sm:gap-6">
            {[...Array(cardsPerView)].map((_, i) => (
              <div
                key={i}
                className="flex-1 bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-lg animate-pulse"
              >
  ...
  const maxIndex = Math.max(0, activeActivitiesCategories.length - cardsPerView);
                    ...
                    <div
                      ...
                      style={{
                        width: `calc(${100 / cardsPerView}% - ${
                          ((cardsPerView - 1) * (cardsPerView === 1 ? 0 : cardsPerView === 2 ? 12 : 16)) / cardsPerView
                        }px)`,
                      }}
                    >
                      <div
                              ...
                              {category.numberOfActivities > 0 && (
                                <div className="flex justify-center mb-2 sm:mb-3">
                                  <span className="text-xs text-gray-500">
                                    {category.numberOfActivities} activit{category.numberOfActivities !== 1 ? "ies" : "y"}{" "}
                                    available
                                  </span>
                                </div>
                              )}
