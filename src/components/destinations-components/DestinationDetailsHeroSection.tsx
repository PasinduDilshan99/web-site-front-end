...
const DestinationDetailsHeroSection: React.FC<DestinationDetailsHeroSectionProps> = ({
  ...
  if (!destination.images.length) {
    return (
      <div className="relative h-96 bg-gradient-to-r from-emerald-600 to-cyan-600 flex items-center justify-center">
  ...
  return (
    <>
      ...
      <div className="relative h-[500px] md:h-[600px] overflow-hidden bg-gradient-to-r from-emerald-600 to-cyan-600">
        {/* Image Slider */}
        ...
        {/* Content Overlay - Adjusted padding to avoid weather widget */}
        <div className="absolute inset-0 flex items-end z-10">
          <div className="container mx-auto px-4 md:px-6 lg:px-8 pb-12">
            <div className="max-w-4xl text-white">
              {/* Destination Category Badge */}
              <div className="hidden mb-4 lg:flex flex-wrap gap-3">
                <span className="px-4 py-2 bg-emerald-500/90 backdrop-blur-sm rounded-full text-sm font-semibold">
                  {destination.categoryName}
                </span>
                <span className="px-4 py-2 bg-amber-500/90 backdrop-blur-sm rounded-full text-sm font-semibold flex items-center gap-2">
                ...
                {destination.activities && destination.activities.length > 0 && (
                  <span className="px-4 py-2 bg-purple-500/90 backdrop-blur-sm rounded-full text-sm font-semibold flex items-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="pr-0 md:pr-48">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 max-w-3xl mb-6">
                  <p className="text-md md:text-lg lg:text-xl text-gray-100 leading-relaxed mb-4">
