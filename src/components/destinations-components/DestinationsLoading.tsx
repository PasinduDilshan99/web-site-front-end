...
const DestinationsLoading = ({ itemsPerPage }: { itemsPerPage: number }) => {
  return (
      ...
      <div className="mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="h-9 bg-gradient-to-r from-gray-700 to-teal-800/50 rounded-md w-28 animate-pulse border border-teal-500/20"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-6 border-t border-teal-500/20">
          ...
          <div className="flex items-center gap-1">
            <div className="h-9 bg-gradient-to-r from-gray-700 to-teal-800/50 rounded-md w-20 animate-pulse"></div>
            <div className="flex gap-1">
              {[...Array(5)].map((_, i) => (
                <div
                  key={i}
                  className="h-9 w-9 bg-gradient-to-r from-gray-700 to-teal-800/50 rounded-md animate-pulse"
                ></div>
              ))}
            </div>
            <div className="h-9 bg-gradient-to-r from-gray-700 to-teal-800/50 rounded-md w-20 animate-pulse"></div>
