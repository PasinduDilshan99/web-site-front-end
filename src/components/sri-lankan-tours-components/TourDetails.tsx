    ...
    <div className="p-4 sm:p-5 md:p-6 flex-1 flex flex-col gap-3 sm:gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          >
            <svg className="w-3 h-3" style={{ color: "#0B7EA8" }} fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
            </svg>
          </span>
          <span className="truncate">
            <span className="font-semibold text-gray-500 text-xs uppercase tracking-wide mr-1">From</span>
            <span className="font-medium text-gray-800">{tour.startLocation}</span>
          </span>
        </div>

        {/* Connector line */}
        <div className="flex items-center gap-2 ml-2.5">
          <div className="w-px h-3 ml-[7px] rounded-full" style={{ background: "linear-gradient(to bottom, #0B7EA8, #0E9E8E)" }} />
        </div>
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          >
            <svg className="w-3 h-3" style={{ color: "#0E9E8E" }} fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
            </svg>
          </span>
          <span className="truncate">
            <span className="font-semibold text-gray-500 text-xs uppercase tracking-wide mr-1">To</span>
            <span className="font-medium text-gray-800">{tour.endLocation}</span>
          </span>
        </div>
      </div>
