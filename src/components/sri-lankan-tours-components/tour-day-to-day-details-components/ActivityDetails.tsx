      ...
      <div className="p-6 bg-white border-t border-gray-100">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-gradient-to-br from-sky-50 to-cyan-50 p-3 sm:p-4 rounded-lg sm:rounded-xl transition-all duration-300 hover:shadow-sm sm:hover:shadow-md border border-sky-100">
        ...
        {/* <div className="mt-6 p-4 bg-gradient-to-r from-sky-50 to-teal-50 rounded-xl border border-sky-200 transition-all duration-300 hover:shadow-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-3 bg-white rounded-lg border border-sky-100 transition-all duration-300 hover:scale-105">
            ...
            <div className="text-center p-3 bg-white rounded-lg border border-teal-100 transition-all duration-300 hover:scale-105">
