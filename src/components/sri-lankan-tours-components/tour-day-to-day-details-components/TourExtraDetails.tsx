...
const TourExtraDetails: React.FC<TourExtraDetailsProps> = ({
  ...
  // If you modified the component to accept a message prop
  if (error) {
        ...
        return (
          <div className="space-y-4">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
              <div
                className={`w-7 h-7 sm:w-8 sm:h-8 rounded-md sm:rounded-lg ${colorClasses.bg} flex items-center justify-center flex-shrink-0`}
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {details.inclusions.map((item) => (
                <div
                  key={item.id}
                  className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 hover:border-emerald-300 hover:shadow-sm transition-all duration-200 group"
                >
                  <div className="flex items-start gap-2 sm:gap-3">
                    <div className="flex-shrink-0">
                      <div
                        className={`text-emerald-600 w-8 h-8 sm:w-10 sm:h-10 ${colorClasses.bg} rounded-lg flex items-center justify-center`}
                      >
                        {getIconForInclusion(item.description)}
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-gray-700 text-sm sm:text-base leading-relaxed group-hover:text-gray-900 line-clamp-3 sm:line-clamp-4">
                        {item.description}
                      </p>
                    </div>
                  </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {details.exclusions.map((item) => (
                <div
                  key={item.id}
                  className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 hover:border-red-300 hover:shadow-sm transition-all duration-200 group"
                >
                  <div className="flex items-start gap-2 sm:gap-3">
                    <div className="flex-shrink-0">
                      <div
                        className={`w-8 h-8 sm:w-10 sm:h-10 ${colorClasses.bg} rounded-lg flex items-center justify-center`}
                      >
                        <XCircle className="w-3 h-3 sm:w-4 sm:h-4 text-red-600" />
                      </div>
                    </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 sm:space-y-4">
              {details.conditions.map((item) => (
                <div
                  key={item.id}
                  className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 hover:border-amber-300 hover:shadow-sm transition-all duration-200 group"
                >
                  <div className="flex items-start gap-2 sm:gap-3">
                    <div className="flex-shrink-0">
                      <div
                        className={`text-amber-600 w-8 h-8 sm:w-10 sm:h-10 ${colorClasses.bg} rounded-lg flex items-center justify-center`}
                      >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {details.travelTips.map((tip) => (
                <div
                  key={tip.id}
                  className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 lg:p-5 hover:border-blue-300 hover:shadow-sm transition-all duration-200 group h-full"
                >
                  <div className="flex flex-col h-full">
                    <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                      <div className="flex-shrink-0">
                        <div
                          className={`text-blue-600 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 ${colorClasses.bg} rounded-lg flex items-center justify-center`}
                        >
                          {getIconForTravelTip(tip.title)}
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-gray-900 text-base sm:text-lg group-hover:text-blue-700 line-clamp-2">
                          {tip.title}
                        </h4>
                      </div>
                    </div>
    ...
    <section className="py-8 sm:py-12 md:py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gray-900 rounded-full mb-4 sm:mb-5 md:mb-6">
            <Info className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" />
          </div>
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`
                 cursor-pointer relative flex flex-col items-center justify-center p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl
                transition-all duration-300 ease-out min-h-[100px] sm:min-h-[120px]
                ${
                  isActive
                    ? `${colorClasses.dark} text-white shadow-md sm:shadow-lg transform scale-[1.02]`
                    : `bg-white ${colorClasses.border} border text-gray-700 hover:shadow-sm sm:hover:shadow-md`
                }
              `}
                >
                  <div
                    className={`flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-md sm:rounded-lg mb-2 sm:mb-3 ${
                  ...
                  {/* Active indicator */}
                  {isActive && (
                    <div className="absolute -bottom-1 sm:-bottom-2 left-1/2 transform -translate-x-1/2 w-2 h-2 sm:w-3 sm:h-3 bg-white rotate-45"></div>
                  )}
                </button>
              );
            })}
        ...
        {/* Important Note */}
        <div className="mt-6 sm:mt-8 md:mt-10 bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6">
          <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h4 className="font-medium text-gray-900 text-sm sm:text-base md:text-lg mb-1 sm:mb-2">
              ...
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                ...
                consultants 48 hours prior to departure. For the most current
                information and any last-minute changes, refer to your booking
        ...
        {/* Quick Stats */}
        <div className="mt-6 sm:mt-8 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
          <div className="bg-gray-50 rounded-lg p-3 sm:p-4 text-center">
            <div className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-1">
              {details.inclusions.length}
            </div>
            <div className="text-xs sm:text-sm text-gray-600">Inclusions</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 sm:p-4 text-center">
            <div className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-1">
              {details.exclusions.length}
            </div>
            <div className="text-xs sm:text-sm text-gray-600">Exclusions</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 sm:p-4 text-center">
            <div className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-1">
              {details.conditions.length}
            </div>
            <div className="text-xs sm:text-sm text-gray-600">Conditions</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 sm:p-4 text-center">
            <div className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-1">
              {details.travelTips.length}
            </div>
            <div className="text-xs sm:text-sm text-gray-600">Travel Tips</div>
          </div>
        </div>
      </div>
    </section>
