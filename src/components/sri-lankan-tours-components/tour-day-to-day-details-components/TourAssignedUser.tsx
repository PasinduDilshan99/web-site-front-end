...
import { TourAssignedEmployeeResponse } from "@/app/sri-lankan-tours/[sriLankanTourId]/page";
import { 
  MapPin, 
  Phone, 
  Mail, 
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 mt-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="px-3 py-1 bg-gradient-to-r from-purple-100 to-amber-100 rounded-full">
      ...
      <div className="flex items-start space-x-4 mb-6 pb-6 border-b border-gray-100">
        <div className="relative">
          <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-gradient-to-r from-amber-500 to-purple-500">
            {assignUser.imageUrl ? (
              <img
                ...
                onError={(e) => {
                  ...
                  target.parentElement!.innerHTML = `
                    <div class="w-full h-full bg-gradient-to-r from-amber-200 to-purple-200 flex items-center justify-center">
              ...
              <div className="w-full h-full bg-gradient-to-r from-amber-200 to-purple-200 flex items-center justify-center">
          ...
          <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-gradient-to-r from-amber-600 to-purple-600 rounded-full border-2 border-white flex items-center justify-center">
      ...
      <div className="space-y-4 mb-6">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-purple-50 to-amber-50 flex items-center justify-center">
        ...
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-amber-50 to-purple-50 flex items-center justify-center">
      ...
      {assignUser.assignMessage && (
        <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-amber-50 rounded-lg border border-purple-100">
          ...
          <div className="space-y-2">
            {displayTours.map((tour) => (
              <a
                ...
                className="block p-3 rounded-lg hover:bg-gray-50 transition-colors border border-gray-100 hover:border-purple-200"
              >
