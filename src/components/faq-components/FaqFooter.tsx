      ...
      <div className="flex flex-col lg:flex-row lg:items-stretch lg:justify-between lg:gap-8 mt-6 sm:mt-8 md:mt-10 lg:mt-12">
        ...
        {hasMoreFaqs && !showAll && (
          <div className="flex-1">
            <div className="h-full flex flex-col justify-between bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 border border-sky-100 bg-gradient-to-br from-white to-sky-50 transition-all duration-300 hover:shadow-2xl hover:scale-105">
        ...
        <div className={`flex-1 ${hasMoreFaqs && !showAll ? 'mt-6 lg:mt-0' : ''}`}>
          <div className="h-full flex flex-col justify-between bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 border border-teal-100 bg-gradient-to-br from-white to-teal-50 transition-all duration-300 hover:shadow-2xl hover:scale-105">
            <div>
              <h3 className="sm:text-md md:text-lg lg:text-xl font-bold text-gray-900 mb-3 sm:mb-4">
