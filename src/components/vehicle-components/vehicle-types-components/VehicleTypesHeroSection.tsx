// components/vehicle-types-components/VehicleTypesHeroSection.tsx
"use client";
...
const VehicleTypesHeroSection = () => {
  ...
  if (error || heroData.length === 0) {
    return (
      <div className="relative w-full h-[600px] md:h-[700px] overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-pink-900 flex items-center justify-center">
        <div className="text-center text-white px-4">
          ...
          <div className="space-y-4">
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 mr-4 shadow-md"
            >
              Retry
            </button>
            <Link
  ...
  return (
    <div className="relative w-full h-[650px] lg:h-[800px] overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-pink-900">
      {/* Image Slider */}
            ...
            >
              {hasImage ? (
                <div
                  ...
                  style={{
                    backgroundImage: `linear-gradient(rgba(15, 23, 42, 0.6), rgba(168, 85, 247, 0.5)), url('${item.imageUrl}')`,
                  }}
                  onError={() => handleImageError(index)}
                />
              ) : (
                <div className="w-full h-full bg-gradient-to-br from-slate-900 via-purple-900 to-pink-900" />
              )}
            </div>
          );
        })}
            ...
            <div className="mb-8">
              ...
              {currentSlideData.subtitle && (
                <div className="mb-6">
                  ...
                  <div className="w-20 h-1 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mx-auto shadow-lg"></div>
                </div>
              )}
            </div>
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  {currentSlideData.primaryButtonText && (
                    <button
                      ...
                      className="cursor-pointer px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-xl hover:from-purple-600 hover:to-pink-600 transform hover:scale-105 transition-all duration-300 shadow-xl flex items-center gap-3 group"
                    >
                      <svg
            ...
            <div className="lg:grid grid-cols-1 md:grid-cols-3 gap-4 hidden mx-auto max-w-4xl">
              <div className="flex items-center gap-3 px-5 py-4 bg-white/5 backdrop-blur-sm rounded-xl border border-purple-500/20 hover:border-purple-400/40 hover:bg-white/10 transition-all duration-300">
                ...
                <div className="text-left">
                  <p className="text-sm text-purple-200/90">Wide Selection</p>
              ...
              <div className="flex items-center gap-3 px-5 py-4 bg-white/5 backdrop-blur-sm rounded-xl border border-pink-500/20 hover:border-pink-400/40 hover:bg-white/10 transition-all duration-300">
                ...
                <div className="text-left">
                  <p className="text-sm text-pink-200/90">Quick Booking</p>
                  <p className="text-base font-bold text-white">
                    Easy Reservation
                  </p>
                </div>
              ...
              <div className="flex items-center gap-3 px-5 py-4 bg-white/5 backdrop-blur-sm rounded-xl border border-indigo-500/20 hover:border-indigo-400/40 hover:bg-white/10 transition-all duration-300">
                ...
                <div className="text-left">
                  <p className="text-sm text-indigo-200/90">Quality Assured</p>
                  <p className="text-base font-bold text-white">
      ...
      {heroData.length > 1 && (
        <div className="absolute bottom-0 left-0 w-full h-1.5 bg-white/10">
          <div
            className="h-full bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400 transition-all duration-500"
            style={{
