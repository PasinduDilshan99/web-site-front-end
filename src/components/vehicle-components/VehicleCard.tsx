// components/vehicles-components/VehicleCard.tsx
"use client";
...
const VehicleCard: React.FC<VehicleCardProps> = ({ vehicle }) => {
  ...
  const handleMoreDetails = () => {
    router.push(`/vehicles/${vehicle.vehicleId}?name=${vehicle.specification.make} ${vehicle.specification.model}`);
  };
  ...
  return (
    <div className="group bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-blue-100 relative">
      ...
      <div className="relative">
        ...
        {/* Make/Model Badge */}
        <div className="absolute top-2 sm:top-3 left-2 sm:left-3 bg-blue-600/90 text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
      ...
      <div className="p-3 sm:p-4 md:p-6">
        {/* Title */}
        <h2 className="text-base sm:text-lg md:text-xl font-bold text-blue-900 mb-1 sm:mb-2">
          {vehicle.specification.make} {vehicle.specification.model} ({vehicle.specification.year})
        </h2>
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            <svg
              className="w-3 h-3 sm:w-4 sm:h-4 text-indigo-600 flex-shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <div className="grid grid-cols-2 gap-2 mb-3 sm:mb-4">
          <div className="bg-blue-50 rounded-lg p-2">
            <p className="text-xs text-blue-600">Engine</p>
            <p className="text-xs sm:text-sm font-semibold text-blue-900">
              {vehicle.specification.engineType}
            </p>
          </div>
          <div className="bg-indigo-50 rounded-lg p-2">
            <p className="text-xs text-indigo-600">Transmission</p>
        ...
        {/* Features Highlights */}
        {(vehicle.specification.sunroofType !== "None" || vehicle.specification.cruiseControlType !== "None") && (
        ...
        <button
          ...
          className="cursor-pointer w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-2 sm:py-3 rounded-lg sm:rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 text-sm sm:text-base shadow-md hover:shadow-lg"
        >
          View Details
        </button>
      </div>
