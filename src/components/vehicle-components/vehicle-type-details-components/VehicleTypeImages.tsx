// components/vehicle-type-components/VehicleTypeImages.tsx
"use client";
import React, { useState } from "react";
import Image from "next/image";
import { VehicleTypeImage } from "@/types/vehicle-types";

interface VehicleTypeImagesProps {
  images: VehicleTypeImage[];
  vehicleTypeName: string;
}

const VehicleTypeImages: React.FC<VehicleTypeImagesProps> = ({
  images,
  vehicleTypeName,
}) => {
  const [selectedImage, setSelectedImage] = useState<VehicleTypeImage | null>(
  ...
  const handleThumbnailClick = (image: VehicleTypeImage) => {
          ...
          {selectedImage && !failedImages.has(selectedImage.imageId) ? (
            <>
              <Image
                ...
                alt={selectedImage.imageName || vehicleTypeName}
...
export default VehicleTypeImages;