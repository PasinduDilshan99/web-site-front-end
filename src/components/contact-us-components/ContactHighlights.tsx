    ...
    switch (method.action) {
      case "call":
        return (
          <button
            ...
            className="cursor-pointer px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-lg hover:from-blue-700 hover:to-cyan-600 transition-all duration-300 text-sm font-medium flex items-center gap-2 shadow-md hover:shadow-lg"
          >
            <svg
              className="w-4 h-4"
              fill="none"
      ...
      case "whatsapp":
        return (
          <button
            onClick={() => handleContactAction(method)}
            className="cursor-pointer px-4 py-2 bg-gradient-to-r from-green-500 to-teal-400 text-white rounded-lg hover:from-green-600 hover:to-teal-500 transition-all duration-300 text-sm font-medium flex items-center gap-2 shadow-md hover:shadow-lg"
          >
      ...
      case "email":
        return (
          <button
            onClick={() => handleContactAction(method)}
            className="cursor-pointer px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 text-sm font-medium flex items-center gap-2 shadow-md hover:shadow-lg"
          >
            <svg
              className="w-4 h-4"
              fill="none"
      ...
      case "location":
        return (
          <button
            onClick={() => handleContactAction(method)}
            className="cursor-pointer px-4 py-2 bg-gradient-to-r from-blue-500 to-teal-400 text-white rounded-lg hover:from-blue-600 hover:to-teal-500 transition-all duration-300 text-sm font-medium flex items-center gap-2 shadow-md hover:shadow-lg"
          >
            <svg
              className="w-4 h-4"
              fill="none"
      ...
      case "emergency":
        return (
          <button
            onClick={() => handleContactAction(method)}
            className="cursor-pointer px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg hover:from-red-600 hover:to-red-700 transition-all duration-300 text-sm font-medium flex items-center gap-2 shadow-md hover:shadow-lg animate-pulse"
          >
            <svg
              className="w-4 h-4"
              fill="none"
