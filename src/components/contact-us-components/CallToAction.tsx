...
import {
  ...
  COMPANY_SMS_CONTACT_NUMBER_LINK,
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-14 lg:mb-16">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-5 md:gap-6 mb-10 sm:mb-12 md:mb-14 lg:mb-16 px-4">
            <button
              onClick={() => {
                window.location.href = `${COMPANY_SMS_CONTACT_NUMBER_LINK}`;
              }}
            ...
            >
              ...
              <svg
                className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-2 transition-transform flex-shrink-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <a
              href={COMPANY_WHATSAPP_CONTACT_NUMBER_LINK}
              target="_blank"
          ...
          <div className="relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-2xl border border-gray-100">
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm md:text-base text-gray-600 mb-6 sm:mb-7 md:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
                Every great journey begins with a single step. Our team of
                travel experts is ready to help you take that step today.
                Whether you&apos;re dreaming of a beach getaway, cultural
                exploration, or luxury retreat, we&apos;ll make it happen.
              </p>

              <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 px-4">
                <button
                  onClick={() => {
                    window.location.href = SRI_LANKAN_TOUR_PAGE_PATH;
                  }}
              ...
              <div className="mt-6 sm:mt-7 md:mt-8 pt-5 sm:pt-6 border-t border-gray-200">
                <p className="text-gray-500 text-xs sm:text-sm px-4">
                  No commitment required for initial consultation. Let&apos;s
                  just chat about your travel dreams!
                </p>
              </div>
            </div>
          </div>
