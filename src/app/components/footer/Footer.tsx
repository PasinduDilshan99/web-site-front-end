          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-lg font-bold">CEYLON EMPIRE</div>
                  <div className="text-xs text-gray-400 uppercase tracking-wider">TRAVELS</div>
                </div>
              </div>
            </div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              Ceylon Empire Travels a leading travel agents in Sri Lanka offering 
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  isurika@ceylonempireretr​avels.com
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="text-gray-400 text-sm text-center sm:text-left">
              © {currentYear} Ceylon Empire Travels. All rights reserved.
            </div>
