...
const ActiveBlogsSummery = () => {
  ...
  return (
    <div className="mx-auto px-4 py-16 bg-gradient-to-br from-amber-50 to-purple-50">
      {/* Header */}
      ...
      <div className="relative mx-auto">
        ...
        {activeBlogs.length > 1 && (
          <>
            <button
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 bg-white rounded-full p-3 shadow-lg hover:bg-gray-50 transition-colors duration-200 hidden md:flex items-center justify-center"
            >
              <svg
            ...
            <button
              onClick={nextSlide}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 bg-white rounded-full p-3 shadow-lg hover:bg-gray-50 transition-colors duration-200 hidden md:flex items-center justify-center"
            >
              <svg
                className="w-6 h-6 text-gray-600"
                fill="none"
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {/* Blog Title */}
                    <h3 className="text-xl font-bold text-gray-800 mb-3 leading-tight group-hover:text-amber-600 transition-colors">
                    ...
                    {blogReactions.length > 0 && (
                      <div className="flex items-center space-x-2 mb-4">
                        {blogReactions.map((reaction, reactionIndex) => (
                          <span
                            key={reactionIndex}
                    ...
                    {/* Read More Button */}
                    <button className="inline-flex items-center text-purple-600 hover:text-purple-700 font-medium text-sm transition-colors duration-200">
                      Read more
                      <svg
