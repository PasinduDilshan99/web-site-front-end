      ...
      <div className="flex-1 p-4 md:p-6 lg:p-8 bg-gradient-to-br from-gray-50 to-white min-h-screen">
        <div className="max-w-7xl mx-auto">
          <div className="animate-pulse space-y-8">
            {/* Header Skeleton */}
            <div>
              <div className="h-8 md:h-10 w-48 md:w-64 bg-gray-200 rounded-lg mb-3"></div>
            ...
            <div className="space-y-4">
              {[...Array(2)].map((_, i) => (
                <div key={i} className="h-48 md:h-64 bg-gradient-to-r from-gray-100 to-gray-200 rounded-2xl"></div>
              ))}
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 p-4 md:p-6 lg:p-8 flex items-center justify-center min-h-[60vh]">
        <div className="max-w-md w-full mx-auto text-center">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">Unable to Load Tours</h3>
      ...
      <div className="flex-1 p-4 md:p-6 lg:p-8 flex items-center justify-center min-h-[60vh]">
        <div className="max-w-md w-full mx-auto text-center">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">No Completed Tours</h3>
            <p className="text-gray-600 mb-6">Start your journey and complete your first tour to see it here.</p>
            <button 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 md:mb-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 text-sm md:text-base">Your travel history and completed adventures</p>
            </div>
            <div className="flex items-center space-x-2">
              <span className="px-3 py-1.5 bg-sky-50 text-sky-700 rounded-lg text-sm font-medium border border-sky-200">
                {completedTours.length} Tour{completedTours.length !== 1 ? 's' : ''}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 md:mb-12">
          <div className="bg-white rounded-xl shadow-md border border-gray-200 p-4 md:p-6 text-center hover:shadow-lg transition-shadow duration-300">
            <div className="text-2xl md:text-3xl font-bold text-sky-600 mb-1">{completedTours.length}</div>
        ...
        <div className="space-y-4 md:space-y-6">
          {completedTours.map((tour) => (
            <div key={tour.bookingId} className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              {/* Tour Header */}
              <div className="bg-gradient-to-r from-sky-600 to-teal-600 p-4 md:p-6 text-white">
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-2 md:gap-3 mb-3">
                      <h2 className="text-lg md:text-xl font-bold truncate">{tour.tourName}</h2>
                    ...
                    <p className="text-sky-100 text-sm md:text-base mb-3 md:mb-4 line-clamp-2">{tour.tourDescription}</p>
              ...
              {expandedBooking === tour.bookingId && (
                <div className="p-4 md:p-6 space-y-4 md:space-y-6 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                    <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
                      <h3 className="font-semibold text-gray-800 mb-3 md:mb-4 flex items-center text-sm md:text-base">
                        <svg className="w-4 h-4 md:w-5 md:h-5 mr-2 text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        Package Details
                      </h3>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between py-1">
                          ...
                          <span className="font-semibold text-gray-800 truncate ml-2">{tour.packageName}</span>
                        </div>
                        <div className="flex justify-between py-1">
                          <span className="text-gray-600">Schedule:</span>
                          <span className="font-semibold text-gray-800 truncate ml-2">{tour.packageScheduleName}</span>
                        </div>
                        <div className="flex justify-between py-1">
                          <span className="text-gray-600">Price per person:</span>
                          <span className="font-semibold text-gray-800">{formatCurrency(tour.packagePricePerPerson)}</span>
                        </div>
                        <div className="flex justify-between py-1">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
                      <h3 className="font-semibold text-gray-800 mb-3 md:mb-4 flex items-center text-sm md:text-base">
                        <svg className="w-4 h-4 md:w-5 md:h-5 mr-2 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        Payment Summary
                      </h3>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between py-1">
                          ...
                          <span className="font-semibold text-gray-800">{formatCurrency(tour.totalAmount)}</span>
                        </div>
                        <div className="flex justify-between py-1">
                          <span className="text-gray-600">Discount:</span>
                        ...
                        <div className="flex justify-between py-1">
                          ...
                          <span className="font-semibold text-gray-800">{formatCurrency(tour.taxAmount + tour.insuranceAmount)}</span>
                        </div>
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 mb-3 md:mb-4 flex items-center text-sm md:text-base">
                        <svg className="w-4 h-4 md:w-5 md:h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13 0a6 6 0 01-9 5.197" />
                        </svg>
                        Participants ({tour.participants.length})
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                        {tour.participants.map((participant, index) => (
                          <div key={index} className="bg-white rounded-lg p-3 md:p-4 border border-gray-200 hover:border-sky-200 transition-colors">
                            ...
                            <div className="space-y-1 text-xs md:text-sm text-gray-600">
                              <div className="flex items-center">
                                ...
                                <span>{participant.age} • {participant.gender}</span>
                              </div>
                              <div className="flex items-center">
                                <span className="w-20 text-gray-500">Passport:</span>
                                <span className="truncate">{participant.passportNumber}</span>
                              </div>
                              <div className="flex items-center">
                                <span className="w-20 text-gray-500">Nationality:</span>
                                <span>{participant.nationality}</span>
                              </div>
                              {participant.allergies !== 'None' && (
                                <div className="flex items-center text-amber-600">
                                  <span className="w-20 text-gray-500">Allergies:</span>
                                  <span className="truncate">{participant.allergies}</span>
                                </div>
                              )}
                              {participant.emergencyContactName && (
                                <div className="flex items-center">
                                  <span className="w-20 text-gray-500">Emergency:</span>
                                  <span className="truncate">{participant.emergencyContactName} ({participant.emergencyContactRelationship})</span>
                                </div>
                              )}
                            </div>
                          </div>
                  ...
                  {tour.activities.length > 0 && (
                    <div>
                      <h3 className="font-semibold text-gray-800 mb-3 md:mb-4 flex items-center text-sm md:text-base">
                        <svg className="w-4 h-4 md:w-5 md:h-5 mr-2 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="space-y-3 md:space-y-4">
                        {tour.activities.map((activity, index) => (
                          <div key={index} className="bg-emerald-50 rounded-lg p-3 md:p-4 border border-emerald-200">
                            ...
                            <p className="text-gray-600 text-xs md:text-sm mb-2 md:mb-3 line-clamp-2">{activity.activityDescription}</p>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 text-xs md:text-sm text-gray-600">
                              <div className="flex items-center">
                                <svg className="w-3 h-3 md:w-4 md:h-4 mr-1 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {tour.payments.map((payment, index) => (
                          <div key={index} className="bg-white rounded-lg p-3 md:p-4 border border-gray-200 hover:border-purple-200 transition-colors">
                            <div className="flex flex-col md:flex-row md:items-start justify-between gap-2 md:gap-4 mb-2">
                              <div className="flex-1">
                                <h4 className="font-semibold text-gray-800 mb-1 truncate">{payment.paymentReference}</h4>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 text-xs md:text-sm text-gray-600">
                              ...
                              {payment.transactionId && (
                                <div className="flex items-center truncate">
                                  ...
                                  <span className="ml-2 truncate">{payment.transactionId}</span>
                                </div>
                              )}
                            </div>
                          </div>
                          ...
                          >
                            <div className="flex items-center space-x-2">
                              ...
                              <div className="text-left">
                                <span className="text-xs md:text-sm font-medium text-gray-800 block truncate">{document.documentName}</span>
