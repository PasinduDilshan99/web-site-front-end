...
"use client";
import UserProfileActivityReviewsLoading from "@/components/user-profile-components/Loadings/UserProfileActivityReviewsLoading";
...
export default function ActivityReviewsPage() {
  ...
  if (loading) {
    return <UserProfileActivityReviewsLoading />;
  }
        ...
        {activityReviews.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-xl border border-sky-200 p-8 md:p-12 text-center">
            ...
            <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-3">
              No Activity Reviews Yet
            </h3>
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              You haven&apos;t reviewed any activities yet. Your reviews help
                              ...
                              comment.commentReactions.length > 0 && (
                                <div className="flex gap-1 mt-2">
                                  {comment.commentReactions.map((reaction) => (
                                    ...
                                    >
                                      <ReactionIcon
                                        type={reaction.commentReactionType}
                                      />
                                    </div>
                                  ))}
                                </div>
