...
"use client";
import UserProfileWalletLoading from "@/components/user-profile-components/Loadings/UserProfileWalletLoading";
...
export default function WalletPage() {
  ...
  if (loading) {
    return <UserProfileWalletLoading />;
  }
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium">
                  Wallet #{walletData.walletNumber}
                </span>
              </div>
              <span
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
            ...
            <div className="space-y-5">
              <div>
                ...
                <span
                  className={`inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold border ${getStatusColor(walletData.walletStatusName)}`}
                >
                  {walletData.walletStatusName}
                </span>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-800 text-sm leading-relaxed">
                  {walletData.walletStatusDescription ||
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm">
                  Your travel wallet was successfully created and activated for
                  transactions.
                </p>
              </div>
            </div>
